<template>
  <div>
    ...
    <div class="form-row align-items-center">
        ...
        <div class="col-md mb-4">
      <b-form-group label="Address/From">
...
<div class="form-row align-items-center">
      ...
      <div class="col-md mb-4">
            <b-form-group label="Number">
                <b-select v-model="ticketData.passengersNum" :options="{1: '1', 2: '2', 3: '3', 4: '4'}" />
...
<!-- <div class="ui-bordered px-3 pt-3">
  ...
  <div class="clearfix">
    ...
    <a href="javascript:void(0)" class="ticket-file-add float-left bg-lighter text-muted mt-2 mb-3">
      ...
      <!-- Footer -->
      <b-card-footer>
        <b-btn variant="primary" class="mr-2">Create post</b-btn>
